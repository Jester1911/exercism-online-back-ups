...
namespace estate_executor {
    ...
    int assemble_account_number(int secret_modifier) {
        int zhang_num{zhang::bank_number_part(secret_modifier)};
        int khan_num{khan::bank_number_part(secret_modifier)};
        int garcia_num{garcia::bank_number_part(secret_modifier)};
        int assembled_account_number{zhang_num + khan_num + garcia_num};
